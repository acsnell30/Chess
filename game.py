...
##############################################################
    ...
    def computer_move(self, piece_list):
        ...
        # No valid moves remaining - CPU IS IN CHECK MATE
            ...
            print("1User in check: " + str(self.white_in_check))
            print("1Computer in check: " + str(self.black_in_check))
            if self.black_in_check == True or self.white_in_check == True:
    ...
    def user_in_checkmate(self, piece_list):
        ...
        if valid_moves == False:
            self.white_in_check = self.test_check('user')
            self.black_in_check = self.test_check('user')

            print("User in check: " + str(self.white_in_check))
            print("User in check: " + str(self.black_in_check))
